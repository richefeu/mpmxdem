...
public:
  ...
  mat9<T> get_transpose() const { return mat9<T>(xx, yx, zx, xy, yy, zy, xz, yz, zz); }
...
typedef mat9<size_t> mat9ui;
typedef mat9<bool> mat9b;

/// Dyadic product (tensorial product or otimes)
template <class T> mat9<T> dyadic_product(const vec3<T> &a, const vec3<T> &b) {
  mat9<T> M;
  M.xx = a.x * b.x;
  M.xy = a.x * b.y;
  M.xz = a.x * b.z;
